...
public class GetAudioAnalysisRequestTest extends AbstractDataTest<AudioAnalysis> {
  private final GetTracksAudioAnalysisRequest defaultRequest = ITest.SPOTIFY_API
    .getTracksAudioAnalysis(ITest.ID_TRACK)
    .setHttpManager(
      TestUtil.MockedHttpManager.returningJson(
        "requests/data/tracks/GetAudioAnalysisRequest.json"))
    .build();

  public GetAudioAnalysisRequestTest() throws Exception {
  }
