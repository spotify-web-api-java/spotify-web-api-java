...
public class GetRecentlyPlayedRequestTest extends AbstractDataTest<PagingCursorbased<PlayHistory>> {
  private final GetRecentlyPlayedTracksRequest defaultRequest = ITest.SPOTIFY_API
    ...
    .setHttpManager(
      TestUtil.MockedHttpManager.returningJson(
        "requests/data/player/GetRecentlyPlayedRequest.json"))
    .build();

  public GetRecentlyPlayedRequestTest() throws Exception {
  }
