...
public class GetPlaylistItemsRequestTest extends AbstractDataTest<Paging<PlaylistTrack>> {
  private final GetPlaylistItemsRequest defaultRequest = ITest.SPOTIFY_API
    .getPlaylistItems(ITest.ID_PLAYLIST)
    .setHttpManager(
  ...
  public GetPlaylistItemsRequestTest() throws Exception {
  }
  ...
  public void shouldComplyWithReference() {
    ...
    assertEquals(
      "https://api.spotify.com:443/v1/playlists/3AGOiaoRXMSjswCLtuNqv5/items?fields=description&limit=10&offset=0&market=SE&additional_types=track%2Cepisode",
