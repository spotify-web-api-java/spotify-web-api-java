...
public class GetUsersSavedAlbumsRequestTest extends AbstractDataTest<Paging<SavedAlbum>> {
  private final GetUsersSavedAlbumsRequest defaultRequest = ITest.SPOTIFY_API.getUsersSavedAlbums()
    .setHttpManager(
      TestUtil.MockedHttpManager.returningJson(
        "requests/data/albums/GetUsersSavedAlbumsRequest.json"))
    .limit(ITest.LIMIT)
    .market(ITest.MARKET)
    .offset(ITest.OFFSET)
    .build();

  public GetUsersSavedAlbumsRequestTest() throws Exception {
  }
