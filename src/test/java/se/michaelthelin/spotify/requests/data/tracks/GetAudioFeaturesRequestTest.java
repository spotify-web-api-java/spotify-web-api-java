...
public class GetAudioFeaturesRequestTest extends AbstractDataTest<AudioFeatures> {
  private final GetTracksAudioFeaturesRequest defaultRequest = ITest.SPOTIFY_API
    .getTracksAudioFeatures(ITest.ID_TRACK)
    .setHttpManager(
      TestUtil.MockedHttpManager.returningJson(
        "requests/data/tracks/GetAudioFeaturesRequest.json"))
    .build();

  public GetAudioFeaturesRequestTest() throws Exception {
  }
