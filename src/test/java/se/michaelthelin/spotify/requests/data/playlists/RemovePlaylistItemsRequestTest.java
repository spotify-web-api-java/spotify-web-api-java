...
public class RemovePlaylistItemsRequestTest extends AbstractDataTest<SnapshotResult> {
  private final RemovePlaylistItemsRequest defaultRequest = ITest.SPOTIFY_API
    .removePlaylistItems(ITest.ID_PLAYLIST, ITest.URIS)
    .setHttpManager(
  ...
  public RemovePlaylistItemsRequestTest() throws Exception {
  }
