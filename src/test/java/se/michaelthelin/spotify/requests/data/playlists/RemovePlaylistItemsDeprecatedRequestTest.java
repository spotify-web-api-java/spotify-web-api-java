...
/**
 * @deprecated Use {@link RemovePlaylistItemsRequestTest} instead.
 */
@Deprecated
public class RemovePlaylistItemsDeprecatedRequestTest extends AbstractDataTest<SnapshotResult> {
  private final RemovePlaylistItemsDeprecatedRequest defaultRequest = ITest.SPOTIFY_API
    .removePlaylistItemsDeprecated(ITest.ID_PLAYLIST, ITest.URIS)
    .setHttpManager(
  ...
  public RemovePlaylistItemsDeprecatedRequestTest() throws Exception {
  }
