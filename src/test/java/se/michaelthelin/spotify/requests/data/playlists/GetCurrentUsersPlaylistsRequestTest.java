...
public class GetCurrentUsersPlaylistsRequestTest extends AbstractDataTest<Paging<PlaylistSimplified>> {
  private final GetCurrentUsersPlaylistsRequest defaultRequest = ITest.SPOTIFY_API
  ...
  public GetCurrentUsersPlaylistsRequestTest() throws Exception {
  }
