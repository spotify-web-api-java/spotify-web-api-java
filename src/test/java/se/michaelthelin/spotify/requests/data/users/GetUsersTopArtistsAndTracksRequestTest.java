...
public class GetUsersTopArtistsAndTracksRequestTest extends AbstractDataTest<Paging<Artist>> {
  private final GetUsersTopArtistsAndTracksRequest<Artist> defaultRequest = ITest.SPOTIFY_API
    .<Artist>getUsersTopArtistsAndTracks(ModelObjectType.ARTIST)
    .setHttpManager(
      TestUtil.MockedHttpManager.returningJson(
        "requests/data/users/simplified/GetUsersTopArtistsRequest.json"))
    .limit(ITest.LIMIT)
    .offset(ITest.OFFSET)
    .time_range(ITest.TIME_RANGE)
    .build();

  public GetUsersTopArtistsAndTracksRequestTest() throws Exception {
  }
