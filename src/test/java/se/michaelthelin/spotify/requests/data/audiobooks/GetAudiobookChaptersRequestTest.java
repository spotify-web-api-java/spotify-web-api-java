...
public class GetAudiobookChaptersRequestTest extends AbstractDataTest<Paging<ChapterSimplified>> {
  ...
  public void shouldComplyWithReference() {
    ...
    assertEquals(
      "https://api.spotify.com:443/v1/audiobooks/2IEBhnu61ieYGFRPEJIO40/chapters?limit=10&offset=0",
  ...
  public void shouldReturnDefault(final Paging<ChapterSimplified> chapterPaging) {
    ...
    assertEquals(
      "https://api.spotify.com/v1/audiobooks/2IEBhnu61ieYGFRPEJIO40/chapters?offset=0&limit=20",
