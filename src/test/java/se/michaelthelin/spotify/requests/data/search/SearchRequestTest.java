...
public class SearchRequestTest extends AbstractDataTest<SearchResult> {
  private final SearchForItemRequest defaultRequest = ITest.SPOTIFY_API
    .searchForItem(ITest.Q, ModelObjectType.ARTIST.getType())
    .setHttpManager(
      TestUtil.MockedHttpManager.returningJson(
        "requests/data/search/SearchRequest.json"))
    .limit(ITest.LIMIT)
    .market(ITest.MARKET)
    .offset(ITest.OFFSET)
  ...
  public SearchRequestTest() throws Exception {
  }
