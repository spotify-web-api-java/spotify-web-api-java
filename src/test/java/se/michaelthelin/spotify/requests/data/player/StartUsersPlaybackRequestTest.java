...
public class StartUsersPlaybackRequestTest extends AbstractDataTest<String> {
  private final StartResumePlaybackRequest defaultRequest = ITest.SPOTIFY_API
    .startResumePlayback()
    .setHttpManager(
  ...
  public StartUsersPlaybackRequestTest() throws Exception {
  }
