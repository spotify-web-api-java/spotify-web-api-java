...
public class GetFeaturedPlaylistsRequestTest extends AbstractDataTest<FeaturedPlaylists> {
  private final GetFeaturedPlaylistsRequest defaultRequest = SPOTIFY_API.getFeaturedPlaylists()
    .setHttpManager(
      TestUtil.MockedHttpManager.returningJson(
        "requests/data/playlists/GetFeaturedPlaylistsRequest.json"))
    .country(COUNTRY)
    .limit(LIMIT)
    .locale(LOCALE)
    .offset(OFFSET)
  ...
  public GetFeaturedPlaylistsRequestTest() throws Exception {
  }
