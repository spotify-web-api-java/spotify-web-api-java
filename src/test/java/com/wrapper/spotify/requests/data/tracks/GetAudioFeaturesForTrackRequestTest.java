...
public class GetAudioFeaturesForTrackRequestTest implements ITest<AudioFeatures> {
  private final GetAudioFeaturesForTrackRequest successRequest = SPOTIFY_API
