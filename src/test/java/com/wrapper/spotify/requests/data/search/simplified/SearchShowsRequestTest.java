...
public class SearchShowsRequestTest extends AbstractDataTest<Paging<ShowSimplified>> {
  private final SearchShowsRequest defaultRequest = SPOTIFY_API.searchShows(Q)
    .setHttpManager(
  ...
  public void shouldComplyWithReference() {
    ...
    assertEquals(
      "https://api.spotify.com:443/v1/search?q=Abba&limit=10&market=SE&offset=0&type=show",
