...
public class SkipUsersPlaybackToNextTrackRequestTest implements ITest<String> {
  private final SkipUsersPlaybackToNextTrackRequest successRequest = SPOTIFY_API
