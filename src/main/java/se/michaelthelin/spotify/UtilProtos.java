...
public final class UtilProtos {
  ...
  public interface UrlOrBuilder
     ...
     * <code>required .spotify.Url.Scheme scheme = 1;</code>
     */
    se.michaelthelin.spotify.UtilProtos.Url.Scheme getScheme();
  ...
  public static final class Url extends
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 8: {
              ...
              se.michaelthelin.spotify.UtilProtos.Url.Scheme value = se.michaelthelin.spotify.UtilProtos.Url.Scheme.valueOf(rawValue);
              if (value == null) {
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return se.michaelthelin.spotify.UtilProtos.internal_static_spotify_Url_descriptor;
    }

    protected com.google.protobuf.GeneratedMessage.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return se.michaelthelin.spotify.UtilProtos.internal_static_spotify_Url_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              se.michaelthelin.spotify.UtilProtos.Url.class, se.michaelthelin.spotify.UtilProtos.Url.Builder.class);
    }
    ...
    public enum Scheme
      ...
      public static final com.google.protobuf.Descriptors.EnumDescriptor
          getDescriptor() {
        return se.michaelthelin.spotify.UtilProtos.Url.getDescriptor().getEnumTypes().get(0);
      }
    ...
    public static final class Parameter extends
      ...
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return se.michaelthelin.spotify.UtilProtos.internal_static_spotify_Url_Parameter_descriptor;
      }

      protected com.google.protobuf.GeneratedMessage.FieldAccessorTable
          internalGetFieldAccessorTable() {
        return se.michaelthelin.spotify.UtilProtos.internal_static_spotify_Url_Parameter_fieldAccessorTable
            .ensureFieldAccessorsInitialized(
                se.michaelthelin.spotify.UtilProtos.Url.Parameter.class, se.michaelthelin.spotify.UtilProtos.Url.Parameter.Builder.class);
      }
      ...
      public static se.michaelthelin.spotify.UtilProtos.Url.Parameter parseFrom(
      ...
      public static se.michaelthelin.spotify.UtilProtos.Url.Parameter parseFrom(byte[] data)
          throws com.google.protobuf.InvalidProtocolBufferException {
        return PARSER.parseFrom(data);
      }
      public static se.michaelthelin.spotify.UtilProtos.Url.Parameter parseFrom(
      ...
      public static se.michaelthelin.spotify.UtilProtos.Url.Parameter parseFrom(java.io.InputStream input)
          throws java.io.IOException {
      ...
      public static se.michaelthelin.spotify.UtilProtos.Url.Parameter parseDelimitedFrom(java.io.InputStream input)
          throws java.io.IOException {
        return PARSER.parseDelimitedFrom(input);
      }
      public static se.michaelthelin.spotify.UtilProtos.Url.Parameter parseDelimitedFrom(
          java.io.InputStream input,
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
      ...
      public static Builder newBuilder(se.michaelthelin.spotify.UtilProtos.Url.Parameter prototype) {
      ...
      public static final class Builder extends
         ...
         implements se.michaelthelin.spotify.UtilProtos.Url.ParameterOrBuilder {
        public static final com.google.protobuf.Descriptors.Descriptor
            getDescriptor() {
          return se.michaelthelin.spotify.UtilProtos.internal_static_spotify_Url_Parameter_descriptor;
        }
        ...
        // Construct using se.michaelthelin.spotify.UtilProtos.Url.Parameter.newBuilder()
        private Builder() {
        ...
        public se.michaelthelin.spotify.UtilProtos.Url.Parameter getDefaultInstanceForType() {
          return se.michaelthelin.spotify.UtilProtos.Url.Parameter.getDefaultInstance();
        }

        public se.michaelthelin.spotify.UtilProtos.Url.Parameter build() {
          se.michaelthelin.spotify.UtilProtos.Url.Parameter result = buildPartial();
        ...
        public se.michaelthelin.spotify.UtilProtos.Url.Parameter buildPartial() {
          se.michaelthelin.spotify.UtilProtos.Url.Parameter result = new se.michaelthelin.spotify.UtilProtos.Url.Parameter(this);
        ...
        public Builder mergeFrom(com.google.protobuf.Message other) {
          if (other instanceof se.michaelthelin.spotify.UtilProtos.Url.Parameter) {
            return mergeFrom((se.michaelthelin.spotify.UtilProtos.Url.Parameter)other);
          } else {
        ...
        public Builder mergeFrom(se.michaelthelin.spotify.UtilProtos.Url.Parameter other) {
          if (other == se.michaelthelin.spotify.UtilProtos.Url.Parameter.getDefaultInstance()) return this;
          if (other.hasName()) {
            bitField0_ |= 0x00000001;
            name_ = other.name_;
            onChanged();
        ...
        public Builder mergeFrom(
            ...
            com.google.protobuf.ExtensionRegistryLite extensionRegistry)
            throws java.io.IOException {
          se.michaelthelin.spotify.UtilProtos.Url.Parameter parsedMessage = null;
          try {
            parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
          } catch (com.google.protobuf.InvalidProtocolBufferException e) {
            parsedMessage = (se.michaelthelin.spotify.UtilProtos.Url.Parameter) e.getUnfinishedMessage();
            throw e;
          } finally {
  ...
  bitField0_ |= 0x00000002;
    ...
    public static final class Part extends
      ...
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return se.michaelthelin.spotify.UtilProtos.internal_static_spotify_Url_Part_descriptor;
      }

      protected com.google.protobuf.GeneratedMessage.FieldAccessorTable
          internalGetFieldAccessorTable() {
        return se.michaelthelin.spotify.UtilProtos.internal_static_spotify_Url_Part_fieldAccessorTable
            .ensureFieldAccessorsInitialized(
                se.michaelthelin.spotify.UtilProtos.Url.Part.class, se.michaelthelin.spotify.UtilProtos.Url.Part.Builder.class);
      }
      ...
      public static se.michaelthelin.spotify.UtilProtos.Url.Part parseFrom(
          com.google.protobuf.ByteString data)
          throws com.google.protobuf.InvalidProtocolBufferException {
        return PARSER.parseFrom(data);
      }
      ...
      public static se.michaelthelin.spotify.UtilProtos.Url.Part parseFrom(byte[] data)
          throws com.google.protobuf.InvalidProtocolBufferException {
        return PARSER.parseFrom(data);
      }
      public static se.michaelthelin.spotify.UtilProtos.Url.Part parseFrom(
      ...
      public static se.michaelthelin.spotify.UtilProtos.Url.Part parseFrom(java.io.InputStream input)
          throws java.io.IOException {
        return PARSER.parseFrom(input);
      }
      public static se.michaelthelin.spotify.UtilProtos.Url.Part parseFrom(
      ...
      public static se.michaelthelin.spotify.UtilProtos.Url.Part parseDelimitedFrom(java.io.InputStream input)
          throws java.io.IOException {
        return PARSER.parseDelimitedFrom(input);
      }
      public static se.michaelthelin.spotify.UtilProtos.Url.Part parseDelimitedFrom(
          java.io.InputStream input,
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        return PARSER.parseDelimitedFrom(input, extensionRegistry);
      ...
      public static Builder newBuilder() { return Builder.create(); }
      public Builder newBuilderForType() { return newBuilder(); }
      public static Builder newBuilder(se.michaelthelin.spotify.UtilProtos.Url.Part prototype) {
        return newBuilder().mergeFrom(prototype);
      }
      public Builder toBuilder() { return newBuilder(this); }
      ...
      public static final class Builder extends
          com.google.protobuf.GeneratedMessage.Builder<Builder>
         implements se.michaelthelin.spotify.UtilProtos.Url.PartOrBuilder {
        public static final com.google.protobuf.Descriptors.Descriptor
            getDescriptor() {
          return se.michaelthelin.spotify.UtilProtos.internal_static_spotify_Url_Part_descriptor;
        }
        ...
        // Construct using se.michaelthelin.spotify.UtilProtos.Url.Part.newBuilder()
        private Builder() {
          maybeForceBuilderInitialization();
        }
        ...
        public se.michaelthelin.spotify.UtilProtos.Url.Part getDefaultInstanceForType() {
          return se.michaelthelin.spotify.UtilProtos.Url.Part.getDefaultInstance();
        }

        public se.michaelthelin.spotify.UtilProtos.Url.Part build() {
          se.michaelthelin.spotify.UtilProtos.Url.Part result = buildPartial();
          if (!result.isInitialized()) {
            throw newUninitializedMessageException(result);
          }
          return result;
        ...
        public se.michaelthelin.spotify.UtilProtos.Url.Part buildPartial() {
          se.michaelthelin.spotify.UtilProtos.Url.Part result = new se.michaelthelin.spotify.UtilProtos.Url.Part(this);
          int from_bitField0_ = bitField0_;
          int to_bitField0_ = 0;
          if (((from_bitField0_ & 0x00000001) == 0x00000001)) {
            to_bitField0_ |= 0x00000001;
        ...
        public Builder mergeFrom(com.google.protobuf.Message other) {
          if (other instanceof se.michaelthelin.spotify.UtilProtos.Url.Part) {
            return mergeFrom((se.michaelthelin.spotify.UtilProtos.Url.Part)other);
          } else {
            super.mergeFrom(other);
            return this;
          }
        ...
        public Builder mergeFrom(se.michaelthelin.spotify.UtilProtos.Url.Part other) {
          if (other == se.michaelthelin.spotify.UtilProtos.Url.Part.getDefaultInstance()) return this;
          if (other.hasName()) {
            bitField0_ |= 0x00000001;
            name_ = other.name_;
            onChanged();
        ...
        public Builder mergeFrom(
            ...
            com.google.protobuf.ExtensionRegistryLite extensionRegistry)
            throws java.io.IOException {
          se.michaelthelin.spotify.UtilProtos.Url.Part parsedMessage = null;
          try {
            parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
          } catch (com.google.protobuf.InvalidProtocolBufferException e) {
            parsedMessage = (se.michaelthelin.spotify.UtilProtos.Url.Part) e.getUnfinishedMessage();
            throw e;
          } finally {
            if (parsedMessage != null) {
              mergeFrom(parsedMessage);
  ...
  bitField0_ |= 0x00000010;
    ...
    private se.michaelthelin.spotify.UtilProtos.Url.Scheme scheme_;
    /**
     * <code>required .spotify.Url.Scheme scheme = 1;</code>
     */
     ...
     * <code>required .spotify.Url.Scheme scheme = 1;</code>
     */
    public se.michaelthelin.spotify.UtilProtos.Url.Scheme getScheme() {
      return scheme_;
    }
    ...
    public static se.michaelthelin.spotify.UtilProtos.Url parseFrom(
        com.google.protobuf.ByteString data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    ...
    public static se.michaelthelin.spotify.UtilProtos.Url parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static se.michaelthelin.spotify.UtilProtos.Url parseFrom(
    ...
    public static se.michaelthelin.spotify.UtilProtos.Url parseFrom(java.io.InputStream input)
        throws java.io.IOException {
      return PARSER.parseFrom(input);
    }
    public static se.michaelthelin.spotify.UtilProtos.Url parseFrom(
    ...
    public static se.michaelthelin.spotify.UtilProtos.Url parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return PARSER.parseDelimitedFrom(input);
    }
    public static se.michaelthelin.spotify.UtilProtos.Url parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return PARSER.parseDelimitedFrom(input, extensionRegistry);
    ...
    public static Builder newBuilder() { return Builder.create(); }
    public Builder newBuilderForType() { return newBuilder(); }
    public static Builder newBuilder(se.michaelthelin.spotify.UtilProtos.Url prototype) {
      return newBuilder().mergeFrom(prototype);
    }
    public Builder toBuilder() { return newBuilder(this); }
    ...
    public static final class Builder extends
        com.google.protobuf.GeneratedMessage.Builder<Builder>
       implements se.michaelthelin.spotify.UtilProtos.UrlOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return se.michaelthelin.spotify.UtilProtos.internal_static_spotify_Url_descriptor;
      }
      ...
      // Construct using se.michaelthelin.spotify.UtilProtos.Url.newBuilder()
      private Builder() {
        maybeForceBuilderInitialization();
      }
      ...
      public se.michaelthelin.spotify.UtilProtos.Url getDefaultInstanceForType() {
        return se.michaelthelin.spotify.UtilProtos.Url.getDefaultInstance();
      }

      public se.michaelthelin.spotify.UtilProtos.Url build() {
        se.michaelthelin.spotify.UtilProtos.Url result = buildPartial();
        if (!result.isInitialized()) {
          throw newUninitializedMessageException(result);
        }
        return result;
      ...
      public se.michaelthelin.spotify.UtilProtos.Url buildPartial() {
        se.michaelthelin.spotify.UtilProtos.Url result = new se.michaelthelin.spotify.UtilProtos.Url(this);
        int from_bitField0_ = bitField0_;
        int to_bitField0_ = 0;
        if (((from_bitField0_ & 0x00000001) == 0x00000001)) {
          to_bitField0_ |= 0x00000001;
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof se.michaelthelin.spotify.UtilProtos.Url) {
          return mergeFrom((se.michaelthelin.spotify.UtilProtos.Url)other);
        } else {
          super.mergeFrom(other);
          return this;
        }
      ...
      public Builder mergeFrom(se.michaelthelin.spotify.UtilProtos.Url other) {
        if (other == se.michaelthelin.spotify.UtilProtos.Url.getDefaultInstance()) return this;
        if (other.hasScheme()) {
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        se.michaelthelin.spotify.UtilProtos.Url parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (se.michaelthelin.spotify.UtilProtos.Url) e.getUnfinishedMessage();
          throw e;
        } finally {
          if (parsedMessage != null) {
            mergeFrom(parsedMessage);
      ...
      // required .spotify.Url.Scheme scheme = 1;
      private se.michaelthelin.spotify.UtilProtos.Url.Scheme scheme_ = se.michaelthelin.spotify.UtilProtos.Url.Scheme.HTTP;
      /**
       * <code>required .spotify.Url.Scheme scheme = 1;</code>
       */
      public boolean hasScheme() {
       ...
       * <code>required .spotify.Url.Scheme scheme = 1;</code>
       */
      public Builder setScheme(se.michaelthelin.spotify.UtilProtos.Url.Scheme value) {
        if (value == null) {
          throw new NullPointerException();
        }
        bitField0_ |= 0x00000001;
