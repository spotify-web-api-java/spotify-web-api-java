 ...
 * Chapter objects</a> by building instances from this class.
 */
@JsonDeserialize(builder = Chapter.Builder.class)
public class Chapter extends AbstractModelObject {
  ...
  private Chapter(final Builder builder) {
    super(builder);
   ...
   *
   * @return A {@link AudiobookSimplified} object.
   */
  ...
  public String toString() {
    return "Chapter(audioPreviewUrl=" + audioPreviewUrl + ", chapterNumber=" + chapterNumber
        ...
        + ", resumePoint=" + resumePoint + ", type=" + type + ", uri=" + uri + ", audiobook=" + audiobook + ")";
  }
  ...
  /**
   * Builder class for building {@link Chapter} instances.
   */
  ...
  /**
   * JsonUtil class for building {@link Chapter} instances.
   */
  public static final class JsonUtil extends AbstractModelObject.JsonUtil<Chapter> {
    ...
    @Override
    public Chapter createModelObject(JsonObject jsonObject) {
      ...
      return new Builder()
        ...
        .setAudiobook(
          hasAndNotNull(jsonObject, "audiobook")
            ? new AudiobookSimplified.JsonUtil().createModelObject(jsonObject.getAsJsonObject("audiobook"))
            : null)
        .build();
    }
  }
