 ...
 */
@JsonDeserialize(builder = SeekToPositionRequest.Builder.class)
public class SeekToPositionRequest extends AbstractDataRequest<String> {

  /**
   * The private {@link SeekToPositionRequest} constructor.
   *
   * @param builder A {@link SeekToPositionRequest.Builder}.
   */
  private SeekToPositionRequest(final Builder builder) {
    super(builder);
  }
  ...
  /**
   * Builder class for building a {@link SeekToPositionRequest}.
   */
  public static final class Builder extends AbstractDataRequest.Builder<String, Builder> {

    /**
     * Create a new {@link SeekToPositionRequest.Builder}.
     * <p>
     ...
     *
     * @return A custom {@link SeekToPositionRequest}.
     */
    @Override
