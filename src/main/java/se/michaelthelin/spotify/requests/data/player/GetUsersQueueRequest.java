...
public class GetUsersQueueRequest extends AbstractDataRequest<PlaybackQueue> {
  ...
  /**
   * The private {@link GetUsersQueueRequest} constructor.
   *
   * @param builder A {@link GetUsersQueueRequest.Builder}.
   */
  private GetUsersQueueRequest(final Builder builder) {
    super(builder);
  }
  ...
  /**
   * Builder class for building a {@link GetUsersQueueRequest}.
   */
  public static final class Builder extends AbstractDataRequest.Builder<PlaybackQueue, GetUsersQueueRequest.Builder> {

    /**
     * Create a new {@link GetUsersQueueRequest.Builder}.
     * <p>
     ...
     *
     * @return A custom {@link GetUsersQueueRequest}.
     */
    @Override
    public GetUsersQueueRequest build() {
      setPath("/v1/me/player/queue");
      return new GetUsersQueueRequest(this);
    }

    @Override
    protected GetUsersQueueRequest.Builder self() {
      return this;
    }
  }
}
