 ...
 */
@JsonDeserialize(builder = GetPlaylistItemsRequest.Builder.class)
public class GetPlaylistItemsRequest extends AbstractDataRequest<Paging<PlaylistTrack>> {

  /**
   * The private {@link GetPlaylistItemsRequest} constructor.
   *
   * @param builder A {@link GetPlaylistItemsRequest.Builder}.
   */
  private GetPlaylistItemsRequest(final Builder builder) {
    super(builder);
  }
  ...
  /**
   * Builder class for building a {@link GetPlaylistItemsRequest}.
   */
  public static final class Builder extends AbstractDataPagingRequest.Builder<PlaylistTrack, Builder> {

    /**
     * Create a new {@link GetPlaylistItemsRequest.Builder}.
     * <p>
     ...
     *
     * @return A custom {@link GetPlaylistItemsRequest}.
     */
    @Override
    public GetPlaylistItemsRequest build() {
      setPath("/v1/playlists/{playlist_id}/items");
      return new GetPlaylistItemsRequest(this);
    }
