...
public class RemovePlaylistItemsRequest extends AbstractDataRequest<SnapshotResult> {
  ...
  /**
   * The private {@link RemovePlaylistItemsRequest} constructor.
   *
   * @param builder A {@link RemovePlaylistItemsRequest.Builder}.
   */
  private RemovePlaylistItemsRequest(final Builder builder) {
    super(builder);
  }
  ...
  /**
   * Builder class for building a {@link RemovePlaylistItemsRequest}.
   */
  public static final class Builder extends AbstractDataRequest.Builder<SnapshotResult, Builder> {

    /**
     * Create a new {@link RemovePlaylistItemsRequest.Builder}.
     * <p>
     ...
     * @return An {@link RemovePlaylistItemsRequest.Builder}.
    ...
    public Builder tracks(final JsonArray tracks) {
      ...
      return setBodyParameter("items", tracks);
    }
     ...
     *
     * @return A custom {@link RemovePlaylistItemsRequest}.
     */
    @Override
    public RemovePlaylistItemsRequest build() {
      setContentType(ContentType.APPLICATION_JSON);
      setPath("/v1/playlists/{playlist_id}/items");
      return new RemovePlaylistItemsRequest(this);
    }
