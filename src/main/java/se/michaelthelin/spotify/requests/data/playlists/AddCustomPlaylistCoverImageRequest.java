...
public class AddCustomPlaylistCoverImageRequest extends AbstractDataRequest<String> {
  ...
  /**
   * The private {@link AddCustomPlaylistCoverImageRequest} constructor.
   *
   * @param builder A {@link AddCustomPlaylistCoverImageRequest.Builder}.
   */
  private AddCustomPlaylistCoverImageRequest(final Builder builder) {
    super(builder);
  }
  ...
  /**
   * Builder class for building an {@link AddCustomPlaylistCoverImageRequest}.
   */
  public static final class Builder extends AbstractDataRequest.Builder<String, Builder> {
     ...
     * @return A {@link AddCustomPlaylistCoverImageRequest.Builder}.
     ...
     *
     * @return A custom {@link AddCustomPlaylistCoverImageRequest}.
     */
    @Override
    public AddCustomPlaylistCoverImageRequest build() {
      setContentType(ContentType.IMAGE_JPEG);
      setPath("/v1/playlists/{playlist_id}/images");
      return new AddCustomPlaylistCoverImageRequest(this);
    }
