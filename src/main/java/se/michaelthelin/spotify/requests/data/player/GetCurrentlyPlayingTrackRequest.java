 ...
 */
@JsonDeserialize(builder = GetCurrentlyPlayingTrackRequest.Builder.class)
public class GetCurrentlyPlayingTrackRequest extends AbstractDataRequest<CurrentlyPlaying> {

  /**
   * The private {@link GetCurrentlyPlayingTrackRequest} constructor.
   *
   * @param builder A {@link GetCurrentlyPlayingTrackRequest.Builder}.
   */
  private GetCurrentlyPlayingTrackRequest(final Builder builder) {
    super(builder);
  }
  ...
  /**
   * Builder class for building a {@link GetCurrentlyPlayingTrackRequest}.
   */
  public static final class Builder extends AbstractDataRequest.Builder<CurrentlyPlaying, Builder> {

    /**
     * Create a new {@link GetCurrentlyPlayingTrackRequest.Builder}.
     * <p>
     ...
     * @return A {@link GetCurrentlyPlayingTrackRequest.Builder}.
     */
    public GetCurrentlyPlayingTrackRequest.Builder additionalTypes(final String additionalTypes) {
     ...
     *
     * @return A custom {@link GetCurrentlyPlayingTrackRequest}.
     */
    @Override
    public GetCurrentlyPlayingTrackRequest build() {
      setPath("/v1/me/player/currently-playing");
      return new GetCurrentlyPlayingTrackRequest(this);
    }
