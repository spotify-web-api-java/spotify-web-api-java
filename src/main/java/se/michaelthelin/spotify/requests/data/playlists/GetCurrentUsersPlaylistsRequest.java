 ...
 */
@JsonDeserialize(builder = GetCurrentUsersPlaylistsRequest.Builder.class)
public class GetCurrentUsersPlaylistsRequest extends AbstractDataRequest<Paging<PlaylistSimplified>> {

  /**
   * The private {@link GetCurrentUsersPlaylistsRequest} constructor.
   *
   * @param builder A {@link GetCurrentUsersPlaylistsRequest.Builder}.
   */
  private GetCurrentUsersPlaylistsRequest(final Builder builder) {
    super(builder);
  }
  ...
  /**
   * Builder class for building a {@link GetCurrentUsersPlaylistsRequest}
   */
  public static final class Builder extends AbstractDataPagingRequest.Builder<PlaylistSimplified, Builder> {

    /**
     * Create a new {@link GetCurrentUsersPlaylistsRequest.Builder}.
     * <p>
     ...
     *
     * @return A custom {@link GetCurrentUsersPlaylistsRequest}.
     */
    @Override
    public GetCurrentUsersPlaylistsRequest build() {
      setPath("/v1/me/playlists");
      return new GetCurrentUsersPlaylistsRequest(this);
    }
