...
public class TransferPlaybackRequest extends AbstractDataRequest<String> {
  ...
  /**
   * The private {@link TransferPlaybackRequest} constructor.
   *
   * @param builder A {@link TransferPlaybackRequest.Builder}.
   */
  private TransferPlaybackRequest(final Builder builder) {
    super(builder);
  }
  ...
  /**
   * Builder class for building a {@link TransferPlaybackRequest}.
   */
  public static final class Builder extends AbstractDataRequest.Builder<String, Builder> {
     ...
     *
     * @return A custom {@link TransferPlaybackRequest}.
     */
    @Override
    public TransferPlaybackRequest build() {
      setContentType(ContentType.APPLICATION_JSON);
      setPath("/v1/me/player");
      return new TransferPlaybackRequest(this);
    }
