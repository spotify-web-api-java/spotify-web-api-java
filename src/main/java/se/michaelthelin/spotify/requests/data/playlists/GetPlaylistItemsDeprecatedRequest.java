...
public class GetPlaylistItemsDeprecatedRequest extends AbstractDataRequest<Paging<PlaylistTrack>> {
  ...
  * @deprecated Use the new endpoints instead.
   ...
   */
  private GetPlaylistItemsDeprecatedRequest(final Builder builder) {
    super(builder);
  }
  ...
  * @deprecated Use the new endpoints instead.
     ...
     */
    @Override
    public GetPlaylistItemsDeprecatedRequest build() {
      setPath("/v1/playlists/{playlist_id}/tracks");
      return new GetPlaylistItemsDeprecatedRequest(this);
    }
