 ...
 */
@JsonDeserialize(builder = GetUsersSavedAlbumsRequest.Builder.class)
public class GetUsersSavedAlbumsRequest extends AbstractDataRequest<Paging<SavedAlbum>> {

  /**
   * The private {@link GetUsersSavedAlbumsRequest} constructor.
   *
   * @param builder A {@link GetUsersSavedAlbumsRequest.Builder}.
   */
  private GetUsersSavedAlbumsRequest(final Builder builder) {
    super(builder);
  }
  ...
  /**
   * Builder class for building a {@link GetUsersSavedAlbumsRequest}.
   */
  public static final class Builder extends AbstractDataPagingRequest.Builder<SavedAlbum, Builder> {

    /**
     * Create a new {@link GetUsersSavedAlbumsRequest.Builder} instance.
     * <p>
     ...
     *
     * @return A custom {@link GetUsersSavedAlbumsRequest}.
     */
    @Override
    public GetUsersSavedAlbumsRequest build() {
      setPath("/v1/me/albums");
      return new GetUsersSavedAlbumsRequest(this);
    }
