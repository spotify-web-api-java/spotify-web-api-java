...
public class RemovePlaylistItemsDeprecatedRequest extends AbstractDataRequest<SnapshotResult> {
  ...
  * @deprecated Use the new endpoints instead.
   ...
   */
  private RemovePlaylistItemsDeprecatedRequest(final Builder builder) {
    super(builder);
  }
  ...
  * @deprecated Use the new endpoints instead.
     ...
     * @return An {@link RemovePlaylistItemsDeprecatedRequest.Builder}.
  ...
  * @deprecated Use the new endpoints instead.
     ...
     */
    @Override
    public RemovePlaylistItemsDeprecatedRequest build() {
      setContentType(ContentType.APPLICATION_JSON);
      setPath("/v1/playlists/{playlist_id}/tracks");
      return new RemovePlaylistItemsDeprecatedRequest(this);
    }
