...
public class GetFollowedArtistsRequest extends AbstractDataRequest<PagingCursorbased<Artist>> {
  ...
  /**
   * The private {@link GetFollowedArtistsRequest} constructor.
   *
   * @param builder A {@link GetFollowedArtistsRequest.Builder}.
   */
  private GetFollowedArtistsRequest(final Builder builder) {
    super(builder);
  }
  ...
  /**
   * Builder class for building a {@link GetFollowedArtistsRequest}.
   */
  public static final class Builder extends AbstractDataPagingCursorbasedRequest.Builder<Artist, String, Builder> {

    /**
     * Create a new {@link GetFollowedArtistsRequest.Builder} instance.
     * <p>
     ...
     *
     * @return A custom {@link GetFollowedArtistsRequest}.
     */
    @Override
    public GetFollowedArtistsRequest build() {
      setPath("/v1/me/following");
      return new GetFollowedArtistsRequest(this);
    }
