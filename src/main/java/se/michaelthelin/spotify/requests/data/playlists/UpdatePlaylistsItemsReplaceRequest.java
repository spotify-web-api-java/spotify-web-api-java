...
public class UpdatePlaylistsItemsReplaceRequest extends AbstractDataRequest<String> {

  /**
   * The private {@link UpdatePlaylistsItemsReplaceRequest} constructor.
   *
   * @param builder A {@link UpdatePlaylistsItemsReplaceRequest.Builder}.
   */
  private UpdatePlaylistsItemsReplaceRequest(final Builder builder) {
    super(builder);
  }
  ...
  /**
   * Builder class for building a {@link UpdatePlaylistsItemsReplaceRequest}.
   */
  public static final class Builder extends AbstractDataRequest.Builder<String, Builder> {

    /**
     * Create a new {@link UpdatePlaylistsItemsReplaceRequest.Builder}.
     * <p>
     ...
     *
     * @return A custom {@link UpdatePlaylistsItemsReplaceRequest}.
     */
    @Override
    public UpdatePlaylistsItemsReplaceRequest build() {
      setContentType(ContentType.APPLICATION_JSON);
      setPath("/v1/playlists/{playlist_id}/items");
      return new UpdatePlaylistsItemsReplaceRequest(this);
    }
