...
public class GetRecentlyPlayedTracksRequest extends AbstractDataRequest<PagingCursorbased<PlayHistory>> {
  ...
  /**
   * The private {@link GetRecentlyPlayedTracksRequest} constructor.
   *
   * @param builder A {@link GetRecentlyPlayedTracksRequest.Builder}.
   */
  private GetRecentlyPlayedTracksRequest(final Builder builder) {
    super(builder);
  }
  ...
  /**
   * Builder class for building a {@link GetRecentlyPlayedTracksRequest}.
   */
  public static final class Builder extends AbstractDataPagingCursorbasedRequest.Builder<PlayHistory, Date, Builder> {

    /**
     * Create a new {@link GetRecentlyPlayedTracksRequest.Builder}.
     * <p>
     ...
     *
     * @return A custom {@link GetRecentlyPlayedTracksRequest}.
     */
    @Override
    public GetRecentlyPlayedTracksRequest build() {
      setPath("/v1/me/player/recently-played");
      return new GetRecentlyPlayedTracksRequest(this);
    }
