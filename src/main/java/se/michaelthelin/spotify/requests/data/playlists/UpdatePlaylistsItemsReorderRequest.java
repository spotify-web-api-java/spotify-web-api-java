...
public class UpdatePlaylistsItemsReorderRequest extends AbstractDataRequest<SnapshotResult> {
  ...
  /**
   * The private {@link UpdatePlaylistsItemsReorderRequest} constructor.
   *
   * @param builder A {@link UpdatePlaylistsItemsReorderRequest.Builder}.
   */
  private UpdatePlaylistsItemsReorderRequest(final Builder builder) {
    super(builder);
  }
  ...
  /**
   * Builder class for building a {@link UpdatePlaylistsItemsReorderRequest}.
   */
  public static final class Builder extends AbstractDataRequest.Builder<SnapshotResult, Builder> {

    /**
     * Create a new {@link UpdatePlaylistsItemsReorderRequest.Builder}.
     * <p>
     ...
     *
     * @return A custom {@link UpdatePlaylistsItemsReorderRequest}.
     */
    @Override
    public UpdatePlaylistsItemsReorderRequest build() {
      setContentType(ContentType.APPLICATION_JSON);
      setPath("/v1/playlists/{playlist_id}/items");
      return new UpdatePlaylistsItemsReorderRequest(this);
    }
