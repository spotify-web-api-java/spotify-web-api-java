 ...
 */
@JsonDeserialize(builder = GetPlaybackStateRequest.Builder.class)
public class GetPlaybackStateRequest extends AbstractDataRequest<CurrentlyPlayingContext> {

  /**
   * The private {@link GetPlaybackStateRequest} constructor.
   *
   * @param builder A {@link GetPlaybackStateRequest.Builder}.
   */
  private GetPlaybackStateRequest(final Builder builder) {
    super(builder);
  }
  ...
  /**
   * Builder class for building a {@link GetPlaybackStateRequest}.
   */
  public static final class Builder extends AbstractDataRequest.Builder<CurrentlyPlayingContext, Builder> {

    /**
     * Create a new {@link GetPlaybackStateRequest.Builder}.
     * <p>
     ...
     *
     * @return A custom {@link GetPlaybackStateRequest}.
     */
    @Override
    public GetPlaybackStateRequest build() {
      setPath("/v1/me/player");
      return new GetPlaybackStateRequest(this);
    }
