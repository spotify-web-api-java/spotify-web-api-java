 ...
 */
@Deprecated
@JsonDeserialize(builder = GetCategoryPlaylistsRequest.Builder.class)
public class GetCategoryPlaylistsRequest extends AbstractDataRequest<Paging<PlaylistSimplified>> {

  /**
   * The private {@link GetCategoryPlaylistsRequest} constructor.
   *
   * @param builder A {@link GetCategoryPlaylistsRequest.Builder}.
   */
  private GetCategoryPlaylistsRequest(final Builder builder) {
    super(builder);
  }
  ...
  /**
   * Builder class for building a {@link GetCategoryPlaylistsRequest}.
   */
  public static final class Builder extends AbstractDataPagingRequest.Builder<PlaylistSimplified, Builder> {

    /**
     * Create a new {@link GetCategoryPlaylistsRequest.Builder} instance.
     *
     ...
     *
     * @return A custom {@link GetCategoryPlaylistsRequest}.
     */
    @Override
    public GetCategoryPlaylistsRequest build() {
      setPath("/v1/browse/categories/{category_id}/playlists");
      return new GetCategoryPlaylistsRequest(this);
    }
