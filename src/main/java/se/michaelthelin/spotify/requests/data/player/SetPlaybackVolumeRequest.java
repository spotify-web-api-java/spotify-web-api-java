...
public class SetPlaybackVolumeRequest extends AbstractDataRequest<String> {
  ...
  /**
   * The private {@link SetPlaybackVolumeRequest} constructor.
   *
   * @param builder A {@link SetPlaybackVolumeRequest.Builder}.
   */
  private SetPlaybackVolumeRequest(final Builder builder) {
    super(builder);
  }
  ...
  /**
   * Builder class for building a {@link SetPlaybackVolumeRequest}.
   */
  public static final class Builder extends AbstractDataRequest.Builder<String, Builder> {

    /**
     * Create a new {@link SetPlaybackVolumeRequest.Builder}.
     * <p>
     ...
     * The build method.
     *
     * @return A custom {@link SetPlaybackVolumeRequest}.
     */
    @Override
    public SetPlaybackVolumeRequest build() {
      setContentType(ContentType.APPLICATION_JSON);
      setPath("/v1/me/player/volume");
      return new SetPlaybackVolumeRequest(this);
    }
