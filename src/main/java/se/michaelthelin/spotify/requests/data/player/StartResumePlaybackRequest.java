...
public class StartResumePlaybackRequest extends AbstractDataRequest<String> {
  ...
  /**
   * The private {@link StartResumePlaybackRequest} constructor.
   *
   * @param builder A {@link StartResumePlaybackRequest.Builder}.
   */
  private StartResumePlaybackRequest(final Builder builder) {
    super(builder);
  }
  ...
  /**
   * Builder class for building a {@link StartResumePlaybackRequest}.
   */
  public static final class Builder extends AbstractDataRequest.Builder<String, Builder> {

    /**
     * Create a new {@link StartResumePlaybackRequest.Builder}.
     * <p>
     ...
     *
     * @return A custom {@link StartResumePlaybackRequest}.
     */
    @Override
    public StartResumePlaybackRequest build() {
      setContentType(ContentType.APPLICATION_JSON);
      setPath("/v1/me/player/play");
      return new StartResumePlaybackRequest(this);
    }
