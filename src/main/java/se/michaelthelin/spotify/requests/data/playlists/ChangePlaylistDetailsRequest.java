 ...
 */
@JsonDeserialize(builder = ChangePlaylistDetailsRequest.Builder.class)
public class ChangePlaylistDetailsRequest extends AbstractDataRequest<String> {

  /**
   * The private {@link ChangePlaylistDetailsRequest} constructor.
   *
   * @param builder A {@link ChangePlaylistDetailsRequest.Builder}.
   */
  ...
  /**
   * Builder class for building a {@link ChangePlaylistDetailsRequest}.
   */
  public static final class Builder extends AbstractDataRequest.Builder<String, Builder> {

    /**
     * Create a new {@link ChangePlaylistDetailsRequest.Builder}.
     * <p>
     ...
     *
     * @return A custom {@link ChangePlaylistDetailsRequest}.
     */
    @Override
