...
public class GetAlbumTracksRequest extends AbstractDataRequest<Paging<TrackSimplified>> {
  ...
  /**
   * The private {@link GetAlbumTracksRequest} constructor.
   *
   * @param builder A {@link GetAlbumTracksRequest.Builder}.
   */
  private GetAlbumTracksRequest(final Builder builder) {
    super(builder);
  }
  ...
  /**
   * Builder class for building a {@link GetAlbumTracksRequest}.
   */
  public static final class Builder extends AbstractDataPagingRequest.Builder<TrackSimplified, Builder> {

    /**
     * Create a new {@link GetAlbumTracksRequest.Builder} instance.
     *
     ...
     *
     * @return A custom {@link GetAlbumTracksRequest}.
     */
    @Override
    public GetAlbumTracksRequest build() {
      setPath("/v1/albums/{id}/tracks");
      return new GetAlbumTracksRequest(this);
    }
