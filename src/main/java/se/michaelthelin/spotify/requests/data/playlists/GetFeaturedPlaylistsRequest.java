...
public class GetFeaturedPlaylistsRequest extends AbstractDataRequest<FeaturedPlaylists> {
  ...
  /**
   * The private {@link GetFeaturedPlaylistsRequest} constructor.
   *
   * @param builder A {@link GetFeaturedPlaylistsRequest.Builder}.
   */
  private GetFeaturedPlaylistsRequest(final Builder builder) {
    super(builder);
  }
  ...
  /**
   * Builder class for building a {@link GetFeaturedPlaylistsRequest}.
   */
  public static final class Builder extends AbstractDataRequest.Builder<FeaturedPlaylists, Builder> {

    /**
     * Create a new {@link GetFeaturedPlaylistsRequest.Builder} instance.
     *
     ...
     *
     * @return A custom {@link GetFeaturedPlaylistsRequest}.
     */
    @Override
    public GetFeaturedPlaylistsRequest build() {
      setPath("/v1/browse/featured-playlists");
      return new GetFeaturedPlaylistsRequest(this);
    }
