 ...
 */
@JsonDeserialize(builder = GetShowEpisodesRequest.Builder.class)
public class GetShowEpisodesRequest extends AbstractDataRequest<Paging<EpisodeSimplified>> {

  /**
   * The private {@link GetShowEpisodesRequest} constructor.
   *
   * @param builder A {@link GetShowEpisodesRequest.Builder}.
   */
  private GetShowEpisodesRequest(Builder builder) {
    super(builder);
  }
  ...
  /**
   * Builder class for building a {@link GetShowEpisodesRequest}.
   */
  public static final class Builder extends AbstractDataPagingRequest.Builder<EpisodeSimplified, Builder> {

    /**
     * Create a new {@link GetShowEpisodesRequest.Builder} instance.
     * <p>
     ...
     *
     * @return A custom {@link GetShowEpisodesRequest}.
     */
    @Override
    public GetShowEpisodesRequest build() {
      setPath("/v1/shows/{id}/episodes");
      return new GetShowEpisodesRequest(this);
    }
