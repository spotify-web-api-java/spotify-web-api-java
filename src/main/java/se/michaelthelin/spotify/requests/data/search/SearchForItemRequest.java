 ...
 */
@JsonDeserialize(builder = SearchForItemRequest.Builder.class)
public class SearchForItemRequest extends AbstractDataRequest<SearchResult> {

  /**
   * The private {@link SearchForItemRequest} constructor.
   *
   * @param builder A {@link SearchForItemRequest.Builder}.
   */
  private SearchForItemRequest(final Builder builder) {
    super(builder);
  }
  ...
  /**
   * Builder class for building a {@link SearchForItemRequest}.
   */
  public static final class Builder extends AbstractDataRequest.Builder<SearchResult, Builder> {

    /**
     * Create a new {@link SearchForItemRequest.Builder}.
     *
     ...
     *             {@code artist}, {@code audiobook}, {@code episode}, {@code playlist}, {@code show} and {@code track}.
     * @return A {@link SearchForItemRequest.Builder}.
     */
    public Builder type(final String type) {
      assert (type != null);
      assert (type.matches("((^|,)(album|artist|audiobook|episode|playlist|show|track))+$"));
     ...
     */
    @Override
    public SearchForItemRequest build() {
      setPath("/v1/search");
      return new SearchForItemRequest(this);
    }
