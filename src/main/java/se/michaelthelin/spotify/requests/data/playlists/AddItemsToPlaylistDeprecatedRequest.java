...
public class AddItemsToPlaylistDeprecatedRequest extends AbstractDataRequest<SnapshotResult> {
   ...
   */
  private AddItemsToPlaylistDeprecatedRequest(final Builder builder) {
    super(builder);
  }
  ...
  public static final class Builder extends AbstractDataRequest.Builder<SnapshotResult, Builder> {
     ...
     */
    @Override
    public AddItemsToPlaylistDeprecatedRequest build() {
      setContentType(ContentType.APPLICATION_JSON);
      setPath("/v1/playlists/{playlist_id}/tracks");
      return new AddItemsToPlaylistDeprecatedRequest(this);
    }
