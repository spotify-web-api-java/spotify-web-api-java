...
public class RemoveFromLibraryRequest extends AbstractDataRequest<String> {
  ...
  public static final class Builder extends AbstractDataRequest.Builder<String, Builder> {
     ...
     * The URIs setter.
     *
     * @param uris Required. The Spotify URIs to remove. Maximum: 50 URIs.
     * @return A {@link RemoveFromLibraryRequest.Builder}.
     */
    public Builder uris(final String... uris) {
      assert (uris != null);
      assert (uris.length <= 50);
      final JsonArray urisArray = new JsonArray();
      for (final String uri : uris) {
        urisArray.add(uri);
      }
      return setBodyParameter("uris", urisArray);
    }
