...
public class StartResumeUsersPlaybackRequest extends AbstractDataRequest {
	 ...
	 *
	 * @param builder
	 *            A {@link StartResumeUsersPlaybackRequest.Builder}.
	 */
	 ...
	 *
	 * @return A string. <b>Note:</b> This endpoint doesn't return something in
	 *         its response body.
	 * @throws IOException
	 *             In case of networking issues.
	 * @throws SpotifyWebApiException
	 *             The Web API returned an error further specified in this
	...
	public static final class Builder extends AbstractDataRequest.Builder<Builder> {
		 ...
		 * <p>
		 * Your access token must have the {@code user-modify-playback-state}
		 ...
		 *            service.
		 * @see <a href=
		 *      "https://developer.spotify.com/web-api/using-scopes/">Spotify:
		 *      Using Scopes</a>
		 */
		 ...
		 *            If not supplied, the user's currently active device is the
		 *            target.
		 ...
		 *
		 * @param context_uri
		 *            Optional. Spotify URI of the context to play. Valid
		 *            contexts are albums, artists and playlists.
		 * @return A {@link StartResumeUsersPlaybackRequest.Builder}.
		 * @see <a href=
		 *      "https://developer.spotify.com/web-api/user-guide/#spotify-uris-and-ids">Spotify:
		 *      URIs &amp; IDs</a>
		 ...
		 * The offset setter.
		 * <p>
		 * <b>Note:</b> If {@link #context_uri(String)} has been set and
		 * corresponds to an album or playlist object, an offset can be
		 * specified either by track {@code uri} OR {@code position}. If both
		 * are present the request will return an error. If incorrect values are
		 * provided for {@code position} or {@code uri}, the request may be
		 * accepted but with an unpredictable resulting action on playback.
		 *
		 * @param offset
		 *            Optional. Indicates from where in the context playback
		 *            should start. Only available when
		 *            {@link #context_uri(String)} corresponds to an album or
		 *            playlist object, or when the {@link #uris(JsonArray)}
		 *            parameter is used. <br>
		 *            The {@code position} parameter in the {@code offset}
		 *            object is zero based and can’t be negative. <br>
		 *            The {@code uri} parameter in the {@code offset} object is
