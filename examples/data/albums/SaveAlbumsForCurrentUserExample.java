...
/**
 * @deprecated Save one or more albums to the current user's 'Your Music' library.
 */
@Deprecated
public class SaveAlbumsForCurrentUserExample {
  ...
  private static final SpotifyApi spotifyApi = new SpotifyApi.Builder()
    ...
    .build();
  private static final SaveAlbumsForCurrentUserRequest saveAlbumsForCurrentUserRequest = spotifyApi.saveAlbumsForCurrentUser(ids)
    .build();
