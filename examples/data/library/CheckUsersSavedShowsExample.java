...
import com.wrapper.spotify.requests.data.library.CheckUsersSavedShowsRequest;
...
public class CheckUsersSavedShowsExample {
  ...
  public static void checkUsersSavedShows_Async() {
    try {
      final CompletableFuture<Boolean[]> booleansFuture = checkUsersSavedShowsRequest.executeAsync();
  ...
  public static void main(String[] args) {
    checkUsersSavedShows_Sync();
    checkUsersSavedShows_Async();
  }
}
