...
import se.michaelthelin.spotify.requests.data.tracks.RemoveUsersSavedTracksRequest;
...
/**
 * @deprecated Remove one or more tracks from the current user's 'Your Music' library.
 */
@Deprecated
public class RemoveUsersSavedTracksExample {
  ...
  private static final SpotifyApi spotifyApi = new SpotifyApi.Builder()
    ...
    .build();
  private static final RemoveUsersSavedTracksRequest removeUsersSavedTracksRequest = spotifyApi.removeUsersSavedTracks(ids)
    .build();
