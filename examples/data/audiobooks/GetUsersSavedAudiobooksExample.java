...
//          .offset(0)
  ...
  public static void getUsersSavedAudiobooks_Sync() {
    try {
      final Paging<AudiobookSimplified> audiobookPaging = getUsersSavedAudiobooksRequest.execute();
  ...
  public static void getUsersSavedAudiobooks_Async() {
    try {
      final CompletableFuture<Paging<AudiobookSimplified>> audiobookPagingFuture = getUsersSavedAudiobooksRequest.executeAsync();

      // Thread free to do other tasks...

      // Example Only. Never block in production code.
      final Paging<AudiobookSimplified> audiobookPaging = audiobookPagingFuture.join();
