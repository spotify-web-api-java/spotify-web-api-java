...
/**
 * @deprecated Get Spotify catalog information about an artist's top tracks by country.
 */
@Deprecated
public class GetArtistsTopTracksExample {
  ...
  private static final SpotifyApi spotifyApi = new SpotifyApi.Builder()
    ...
    .build();
  private static final GetArtistsTopTracksRequest getArtistsTopTracksRequest = spotifyApi.getArtistsTopTracks(id)
//          .market(CountryCode.SE)
  ...
  public static void getArtistsTopTracks_Async() {
    try {
      final CompletableFuture<Track[]> tracksFuture = getArtistsTopTracksRequest.executeAsync();
