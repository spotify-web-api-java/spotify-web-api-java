...
import se.michaelthelin.spotify.requests.data.playlists.GetPlaylistItemsDeprecatedRequest;
...
/**
 * @deprecated Use {@link GetPlaylistItemsExample} instead.
 */
@Deprecated
public class GetPlaylistItemsDeprecatedExample {
  ...
  private static final SpotifyApi spotifyApi = new SpotifyApi.Builder()
    ...
    .build();
  private static final GetPlaylistItemsDeprecatedRequest getPlaylistItemsRequest = spotifyApi
    .getPlaylistItemsDeprecated(playlistId)
//          .fields("description")
//          .limit(10)
//          .offset(0)
...
//          .additionalTypes("track,episode")
  ...
  public static void getPlaylistItemsDeprecated_Sync() {
    try {
  ...
  public static void getPlaylistItemsDeprecated_Async() {
    try {
  ...
  public static void main(String[] args) {
    getPlaylistItemsDeprecated_Sync();
    getPlaylistItemsDeprecated_Async();
  }
}
