...
import se.michaelthelin.spotify.requests.data.playlists.RemovePlaylistItemsDeprecatedRequest;
...
/**
 * @deprecated Use {@link RemovePlaylistItemsExample} instead.
 */
@Deprecated
public class RemovePlaylistItemsDeprecatedExample {
  ...
  private static final SpotifyApi spotifyApi = new SpotifyApi.Builder()
    ...
    .build();
  private static final RemovePlaylistItemsDeprecatedRequest removeItemsPlaylistRequest = spotifyApi
    .removePlaylistItemsDeprecated(playlistId, tracks)
