...
import se.michaelthelin.spotify.requests.data.playlists.UpdatePlaylistsItemsReorderDeprecatedRequest;
...
/**
 * @deprecated Use {@link UpdatePlaylistsItemsReorderExample} instead.
 */
@Deprecated
public class UpdatePlaylistsItemsReorderDeprecatedExample {
  ...
  private static final SpotifyApi spotifyApi = new SpotifyApi.Builder()
    ...
    .build();
  private static final UpdatePlaylistsItemsReorderDeprecatedRequest reorderPlaylistsItemsRequest = spotifyApi.
    updatePlaylistsItemsReorderDeprecated(playlistId, rangeStart, insertBefore)
